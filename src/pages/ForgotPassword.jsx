...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full  bg-[url('/imgs/black.jpg')] bg-center bg-cover size-full bg-black text-white p-4">
      <div className="bg-amber-400 p-8 rounded-3xl w-full max-w-md text-black text-center">
          ...
          {({ isSubmitting }) => (
            <Form className="flex flex-col gap-4">
              <div className="w-full flex flex-col items-start">
                ...
                <ErrorMessage name="email" component="div" className="text-red-600 text-xs mt-1 ml-12 text-left" />
              </div>
